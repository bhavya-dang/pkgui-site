          ...
          <div className="mb-4 flex gap-1 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-1">
            {installMethods.map((method, idx) => (
              <motion.button
                ...
                className={`flex-1 rounded-lg px-3 py-2 text-sm font-medium transition-[background,color] duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)] ${
                  active === method.id
